...
# ===========================================================================
HOST = "arthur"   # shown as  arthur@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Full Stack Developer"),
    ("kv", "Exp", "3+ years building for the web"),
    ("kv", "Projects", "30+ shipped, mostly front-end"),
    ("kv", "Focus", "SaaS platforms & polished UIs"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Tailwind"),
    ("kv", "Backend", "Node, Prisma, PHP, REST APIs"),
    ("kv", "Mobile", "Kotlin (Android)"),
    ("kv", "Cloud", "AWS S3, Vercel, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "SaaS platform for football school management"),
    ("bul", "Pixel-perfect UIs, delivered end to end"),
]
